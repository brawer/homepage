...
original_title: "Modellieren raumbezogener Daten"
...
abstract: >
  ...
  book first introduces the basics of data modeling and model-based
  data transfer, then works through modeling principles using the
  running Ilistal example, and goes on to cover topics such as
  inheritance, data modeling in general, and the implications for
